...
public class EJBInjector implements PropertyInjector {
	...
	private static final Logger logger = LoggerFactory.getLogger(EJBInjector.class);
	...
	public void inject(final Object obj) {
		List<Field> fields = ReflectionUtils.getFieldsFromClassAndSuperclasses(obj.getClass());
		...
		for (final Field field : fields) {
			...
			for (final Annotation annotation : annotations) {
				AccessController.doPrivileged(new PrivilegedAction() {
					...
					public Object run() {
						try {
							final Object objectToInject = lookup(field, annotation);
	...
	@Override
	public void inject(HttpRequest request, HttpResponse response, Object obj) throws Failure, WebApplicationException,
